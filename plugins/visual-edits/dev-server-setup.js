      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="support@homzy.site" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="support@homzy.site" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
